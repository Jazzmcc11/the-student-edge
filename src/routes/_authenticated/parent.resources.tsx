...
import { ARTICLES, ARTICLES_BY_SLUG, ARTICLE_CATEGORIES, type ArticleCategory, type ParentArticle } from "@/lib/parent-articles";
...
function ParentResourcesPage() {
  ...
  const [filter, setFilter] = useState<ArticleCategory | "all" | "saved">("all");
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-background">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <article className="py-8">
          ...
          <p className="text-sm uppercase tracking-wider text-gold">{ARTICLE_CATEGORIES.find((c) => c.id === article.category)?.label}</p>
...
// silence unused warning if ARTICLES_BY_SLUG isn't referenced elsewhere
