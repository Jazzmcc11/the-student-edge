...
export const GRADE_PLANS: Record<GradeLevel, GradePlan> = {
  ...
  12: {
    ...
    checklist: [
      ...
      { id: "tx-priority", label: "Hit Jan 15 — Texas priority financial aid deadline", href: "/finaid" },
      ...
      // Steps to enrollment (after acceptance)
      { id: "enroll-transcript", label: "Steps to enrollment: send final HS transcript" },
      { id: "enroll-dc-transcript", label: "Steps to enrollment: send Dallas College / dual-credit transcript" },
      { id: "enroll-meningitis", label: "Steps to enrollment: submit meningitis vaccine records" },
      { id: "enroll-tsi-send", label: "Steps to enrollment: send TSI scores to your college" },
      { id: "enroll-orientation-schedule", label: "Steps to enrollment: schedule orientation" },
      { id: "enroll-orientation-attend", label: "Steps to enrollment: attend orientation" },
      { id: "enroll-housing", label: "Steps to enrollment: housing application + deposit" },
    ],
